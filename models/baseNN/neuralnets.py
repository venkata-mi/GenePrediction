...
def regionProposalNetwork(base_layers, noOfAnchors):
	...
	x_class = Conv2D(noOfAnchors, (1, 100), activation='sigmoid', kernel_initializer='uniform', name='rpn_out_class')(x)
	print 'INFO: rpn_out_class: ',x_class
	x_regr = Conv2D(noOfAnchors * 4, (1, 100), activation='linear', kernel_initializer='zero', name='rpn_out_regress')(x)
...
def nn_base(input_tensor = None, trainable = True):
	...
	x = Conv2D(24, (1, 100), activation = 'relu', strides = 1)(sequence_input)
	...
	"""
	x = conv_block(x, 3, [64,64,256], stage = 2, block = 'a', strides = (1,1), trainable = True)
